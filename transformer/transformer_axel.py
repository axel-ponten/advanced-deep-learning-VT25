...
class Transformer2DIceCube(nn.Module):
    def __init__(
        self,
        num_layers = 3,
        nhead = 4,
        ...
        # input embedding, i.e., a linear layer that maps the input features (time, x, y) to the hidden dimension
        d_comp = 128
